 ...
 * @author hijri
 */
public class HalamanLoginDosen extends javax.swing.JFrame {

    /**
     * Creates new form HalamanTiga
     */
    public HalamanLoginDosen() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HalamanLoginDosen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HalamanLoginDosen().setVisible(true);
            }
        });
    }
